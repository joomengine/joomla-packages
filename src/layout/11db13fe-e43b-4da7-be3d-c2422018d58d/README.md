...
## Key:
```php
echo LayoutHelper::render('companydetails', [?]);
```

## PHP:
```php
$areas = [
	'contactname' => JustTEXT::_('Contact Name'),
	'company_type' => JustTEXT::_('Company Type'),
	'companysize' => JustTEXT::_('Company Size'),
	'chamber_of_commerce' => JustTEXT::_('Chamber of Commerce'),
];
```
