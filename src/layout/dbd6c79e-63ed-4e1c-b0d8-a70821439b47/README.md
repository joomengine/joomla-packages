...
## Key:
```php
echo LayoutHelper::render('companycontacts', [?]);
```

## PHP:
```php
$areas = [
	'email' => (object) ['label' => JustTEXT::_('Email'), 'href' => 'mailto:'],
	'phone' => (object) ['label' => JustTEXT::_('Phone'), 'href' => 'tel:'],
	'website' => (object) ['label' => JustTEXT::_('Website'), 'href' => ''],
];
```
