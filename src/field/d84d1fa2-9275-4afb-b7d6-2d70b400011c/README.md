...
<field
	...
	name="company"
	label="Company"
	description="The Company that opened this ticket."
	message="Error: The Company that opened this ticket."
	class="list_class"
