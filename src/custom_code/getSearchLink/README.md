...
## JCB (manual)
```
[CUSTOMCODE=getSearchLink]
```

### Code
```php
$id = $this->input->getInt('id', 0);
$search_link = Joomla___d4c76099_4c32_408a_8701_d0a724484dfd___Power::_(Joomla___92167f18_8543_40e8_92af_053ef4c210d1___Power::[[[arg0]]]($id)) . '/';
